...
export default function ProfileCard() {
  return (
    <div className="w-fit border-6 shadow-2xl border-black p-10 bg-white mt-5 mx-3 lg:mx-0 lg:mt-15 relative">
      {/* گوشه ها */}
      <div className="absolute w-6.5 h-6.5 bg-white border-4 border-black -top-1 -right-1"></div>
      <div className="absolute w-6.5 h-6.5 bg-white border-4 border-black -top-1 -left-1"></div>
      <div className="absolute w-6.5 h-6.5 bg-white border-4 border-black -bottom-1 -left-1"></div>
      <div className="absolute w-6.5 h-6.5 bg-white border-4 border-black -bottom-1 -right-1"></div>
      {/* دایره ها */}
