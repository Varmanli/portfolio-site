...
export default function IntroText({ title, desc }: PropsType) {
  return (
    <div className="relative flex flex-col gap-5 justify-center items-center lg:justify-end lg:items-end">
      ...
      <textarea className="resize-none  outline-none shadow-none bg-white rounded-xl border-3 mx-3 lg:mx-0 p-5 lg:w-[590px] text-lg lg:text-2xl h-[270px] w-[330px] lg:h-[240px] mt-20">
        {desc}
      </textarea>
      <AccentButton
